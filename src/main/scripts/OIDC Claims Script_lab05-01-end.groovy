...
//DONE lab11: import static getContactListPrivilegesArray method in ContactListPrivilegesEvaluator as getContactListPrivileges
import static com.forgerock.edu.policy.ContactListPrivilegesEvaluator.getContactListPrivilegesArray as getContactListPrivileges
...
claimAttributes = [
        ...
        "contactlist-privileges" : { claim, identity, requested -> 
            ...
            if (requested != null) {
                ...
                //DONE lab11: call the imported getContactListPrivileges method with the tokenID string of the current session instead returning with this empty array
                //DONE lab11: Hint: you can get the string version of the token id just like this: session.getTokenID().toString()
                getContactListPrivileges(
                    session.getTokenID().toString())
            } else {
                []
            }
        }
...
scopeClaimsMap = [
        ...
        //DONE lab11: Add the mapping: "contactlist-privileges" scope has the claim named "contactlist-privileges" 
        //DONE lab11: Optionally also add the "selectedRole" claim to the "contactlist-privileges" scope
        "contactlist-privileges": [ "contactlist-privileges", "selectedRole" ]
]
