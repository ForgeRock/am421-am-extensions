...
public class ContactListScopeValidator implements ScopeValidator {
    ...
    // DONE Ch5L1Ex2Task2: add the @Inject annotation
    @Inject
...
//        addScopesBasedOnPrivileges(validatedScope, request);
    ...
    public UserInfoClaims getUserInfo(
        ...
        //DONE Ch5L1Ex2Task3: Add a new claim called "expires_in" which should contain the token's time to live (TTL) in seconds.
