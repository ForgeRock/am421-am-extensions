    ...
    String addContactListPrivilegesAsClaim(OAuth2Request request, String claims) {
        try {
            ...
            claims = Claims.parse(claims)
                    //TODO Ch5L1Ex2: Put a new claim definition named "contactlist-privileges" into the "userinfo" branch - this is needed when the userinfo endpoint is used.
                    //TODO Ch5L1Ex2: Provide the user's privilege set as the hard-coded value for the "contactlist-privileges" claim.
                    //TODO Ch5L1Ex2: Place the same claim definition to the "id_token" branch  - this is relevant during the id_token generation.
                    //TODO Ch5L1Ex2: Hint: use the setClaimValues method of the Claims class to add
                    .toString();
